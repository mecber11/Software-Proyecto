...
def display_hybrid_comparison_results(comparison_data, t):
    ...
    if not comparison_data:
        st.warning("No se encontraron datos de comparación híbrida. Ejecuta 'generar_comparacion_hibrida.py' primero.")
        return
    
    st.markdown("#### 🔬 Análisis Comparativo: Clásicos vs Híbridos")
